...
public class MemberDao implements IMemberDao{
	...
	public int insert(Member m) {
		...
		int result = jdbcTemplate.update(sql, m.getNum(), m.getGender(), m.getName(), m.getAge());
		return result;
	}
	@Override
	public int update(Member m) {
		String sql = "update member set gender = ? name = ? age = ?";
		int result = jdbcTemplate.update(sql, m.getGender(), m.getName(), m.getAge(), m.getNum());
		return result;
	}
	@Override
