...
public class MyAspect {
	//pointcut 정의하기
	//public void 타입의 body가 없는 메서드 위에 pointcut 정의 (메서드의 이름이 pointcut의 id)
	...
	@AfterReturning(pointcut = "mypt()", returning="msg")	//반환값을 받고 싶으면 두번째 파라미터를 넣어줌
	...
	public void afterThrowing(JoinPoint jp,Throwable th) {
		//target 메서드 비정상 종료 후 th에 있는 메시지를 받아옴
